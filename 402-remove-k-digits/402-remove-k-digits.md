<h1>402 - Remove K Digits</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/remove-k-digits/">remove-k-digits</a></h2><p>Given string num representing a non-negative integer <code>num</code>, and an integer <code>k</code>, return <em>the smallest possible integer after removing</em> <code>k</code> <em>digits from</em> <code>num</code>.</p>
