<h1>2662 - Check Knight Tour Configuration</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/check-knight-tour-configuration/">check-knight-tour-configuration</a></h2><p>There is a knight on an <code>n x n</code> chessboard. In a valid configuration, the knight starts <strong>at the top-left cell</strong> of the board and visits every cell on the board <strong>exactly once</strong>.</p>
