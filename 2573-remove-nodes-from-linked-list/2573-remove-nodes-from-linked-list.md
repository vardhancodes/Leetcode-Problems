<h1>2573 - Remove Nodes From Linked List</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/remove-nodes-from-linked-list/">remove-nodes-from-linked-list</a></h2><p>You are given the <code>head</code> of a linked list.</p>
