<h1>759 - Set Intersection Size At Least Two</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/set-intersection-size-at-least-two/">set-intersection-size-at-least-two</a></h2><p>You are given a 2D integer array <code>intervals</code> where <code>intervals[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> represents all the integers from <code>start<sub>i</sub></code> to <code>end<sub>i</sub></code> inclusively.</p>
