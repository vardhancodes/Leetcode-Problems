<h1>3768 - Check If Digits Are Equal in String After Operations I</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-digits-are-equal-in-string-after-operations-i/">check-if-digits-are-equal-in-string-after-operations-i</a></h2><p>You are given a string <code>s</code> consisting of digits. Perform the following operation repeatedly until the string has <strong>exactly</strong> two digits:</p>
