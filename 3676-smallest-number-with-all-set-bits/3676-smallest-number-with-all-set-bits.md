<h1>3676 - Smallest Number With All Set Bits</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/smallest-number-with-all-set-bits/">smallest-number-with-all-set-bits</a></h2><p>You are given a <em>positive</em> number <code>n</code>.</p>
