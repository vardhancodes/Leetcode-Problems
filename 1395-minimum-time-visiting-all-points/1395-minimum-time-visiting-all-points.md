<h1>1395 - Minimum Time Visiting All Points</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/minimum-time-visiting-all-points/">minimum-time-visiting-all-points</a></h2><p>On a 2D plane, there are <code>n</code> points with integer coordinates <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>. Return <em>the <strong>minimum time</strong> in seconds to visit all the points in the order given by </em><code>points</code>.</p>
