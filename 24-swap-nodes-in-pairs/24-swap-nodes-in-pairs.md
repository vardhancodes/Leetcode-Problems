<h1>24 - Swap Nodes in Pairs</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/swap-nodes-in-pairs/">swap-nodes-in-pairs</a></h2><p>Given a&nbsp;linked list, swap every two adjacent nodes and return its head. You must solve the problem without&nbsp;modifying the values in the list&#39;s nodes (i.e., only nodes themselves may be changed.)</p>
