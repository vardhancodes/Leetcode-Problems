<h1>1157 - Insufficient Nodes in Root to Leaf Paths</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/insufficient-nodes-in-root-to-leaf-paths/">insufficient-nodes-in-root-to-leaf-paths</a></h2><p>Given the <code>root</code> of a binary tree and an integer <code>limit</code>, delete all <strong>insufficient nodes</strong> in the tree simultaneously, and return <em>the root of the resulting binary tree</em>.</p>
