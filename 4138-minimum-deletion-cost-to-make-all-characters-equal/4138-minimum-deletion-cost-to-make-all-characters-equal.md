<h1>4138 - Minimum Deletion Cost to Make All Characters Equal</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-deletion-cost-to-make-all-characters-equal/">minimum-deletion-cost-to-make-all-characters-equal</a></h2><p>You are given a string <code>s</code> of length <code>n</code> and an integer array <code>cost</code> of the same length, where <code>cost[i]</code> is the cost to <strong>delete</strong> the <code>i<sup>th</sup></code> character of <code>s</code>.</p>
