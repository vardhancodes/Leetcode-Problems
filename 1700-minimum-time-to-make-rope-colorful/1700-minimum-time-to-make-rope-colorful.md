<h1>1700 - Minimum Time to Make Rope Colorful</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-time-to-make-rope-colorful/">minimum-time-to-make-rope-colorful</a></h2><p>Alice has <code>n</code> balloons arranged on a rope. You are given a <strong>0-indexed</strong> string <code>colors</code> where <code>colors[i]</code> is the color of the <code>i<sup>th</sup></code> balloon.</p>
